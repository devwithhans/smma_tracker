    ...
    return Column(
      ...
      children: [
        ...
        CustomInputForm(
          ...
          maxLines: 1,
          onChanged: (v) {
            context.read<NewCompanyCubit>().updateValues(companyName: v);
          },
          validator: (b) {
            if (b == null || b.isEmpty) {
        ...
        CustomInputForm(
          ...
          validator: (b) {},
          onChanged: (v) {
            context.read<NewCompanyCubit>().updateValues(vatNumber: v);
          },
        ...
        DropDownSearch(
          ...
          onChange: ((v) =>
              context.read<NewCompanyCubit>().updateValues(countryCode: v)),
        ),
      ],
    );
  }
